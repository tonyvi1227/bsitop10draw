...
function renderCombinationFormat(
  ...
  // Bottom Chart Line Trend inside lower frame (lower frame is Y=1986 to 2800 on 3000x3000, and Y=1540 to 2240 on 3000x2400)
  const trendTop = isSquareSocial ? 2280 : 1800;
  const trendBottom = isSquareSocial ? 2740 : 2190;
  ...
  if (nodePoints.length > 0) {
    ...
    nodePoints.forEach((pt, i) => {
      ...
      // Safety bounds check
      const boundBottomLimit = isSquareSocial ? 2720 : 2160;
      const boundTopLimit = isSquareSocial ? 2280 : 1800;
